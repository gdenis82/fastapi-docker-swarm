...
Если вам нужно запустить миграции вручную:
1. Зайдите на менеджер-ноду по SSH.
2. Найдите ID контейнера бэкенда: `docker ps --filter name=fastapi_stack_backend -q`
3. Выполните команду: `docker exec <container_id> alembic upgrade head`
